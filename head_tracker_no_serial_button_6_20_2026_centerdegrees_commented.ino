...
this is edited from example code by Adafruit, who are awesome and deserve good things for how much they bring into the maker community
...
these variables are found below at lines 52 and 53
...
the two pins being used are the reset pin, and pin 18 (A0) for selecting the center of the monitor as the reference point
*/
#include <Arduino.h>
